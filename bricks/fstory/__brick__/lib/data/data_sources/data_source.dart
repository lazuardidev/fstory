...
import 'package:{{appName.snakeCase()}}/data/models/story_model.dart';
import 'package:{{appName.snakeCase()}}/data/models/login_response.dart';
import 'package:{{appName.snakeCase()}}/data/models/server_response.dart';
import 'package:{{appName.snakeCase()}}/data/models/story_detail_response.dart';
import 'package:{{appName.snakeCase()}}/data/models/story_list_response.dart';
